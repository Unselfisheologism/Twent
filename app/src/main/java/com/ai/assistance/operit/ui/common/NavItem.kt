...
// 🎮 Gen Z Navigation Items - Emojis + Minimal Text = Vibes ✨
sealed class NavItem(val route: String, val titleResId: Int, val icon: ImageVector, val emoji: String) {
        ...
        object AssistantConfig :
                NavItem("assistant_config", R.string.nav_assistant_config, Icons.Default.Tune, "⚙️")
        ...
        object Toolbox : NavItem("toolbox", R.string.toolbox, Icons.Default.Apps, "🛠️")
        object About : NavItem("about", R.string.nav_about, Icons.Default.Info, "ℹ️")
        object Mcp : NavItem("mcp", R.string.mcp, Icons.Default.Cloud, "☁️")
        ...
        // 🏆 Gen Z Exclusive Navigation
        object Rewards : NavItem("rewards", R.string.nav_rewards, Icons.Default.EmojiEvents, "🏆")
        object SocialImpact : NavItem("social_impact", R.string.nav_social_impact, Icons.Default.Favorite, "🌍")
        object Streaks : NavItem("streaks", R.string.nav_streaks, Icons.Default.LocalFireDepartment, "🔥")
}
