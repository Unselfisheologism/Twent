...
private fun getDefaultLightColorScheme() = lightColorScheme(
    primary = Color(0xFFF09020), // Orange Primary (from logo)
    onPrimary = Color.White,
    primaryContainer = Color(0xFFFFA040),
    onPrimaryContainer = Color(0xFF301000),
    secondary = Color(0xFF80C0F0), // Blue Primary (from logo)
    onSecondary = Color(0xFF001020),
    secondaryContainer = Color(0xFF90D0F8),
    onSecondaryContainer = Color(0xFF001F2F),
    tertiary = Color(0xFF809090), // Grey (from logo)
    onTertiary = Color.White,
    tertiaryContainer = Color(0xFFA0B0B0),
    onTertiaryContainer = Color(0xFF102020),
...
private fun getDefaultDarkColorScheme() = darkColorScheme(
    ...
    primaryContainer = Color(0xFFC06000),
    onPrimaryContainer = Color(0xFFFFA040),
    secondary = Color(0xFF80C0F0), // Blue Primary (from logo)
    onSecondary = Color(0xFF001020),
    secondaryContainer = Color(0xFF60A0D0),
    onSecondaryContainer = Color(0xFF90D0F8),
    tertiary = Color(0xFF809090), // Grey (from logo)
    onTertiary = Color(0xFF102020),
    tertiaryContainer = Color(0xFF506060),
    onTertiaryContainer = Color(0xFFA0B0B0),
    error = Color(0xFFFF4444),
