...
class TriggerReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_EXECUTE_TASK = "com.ai.assistance.operit.voice.action.EXECUTE_TASK"
        const val EXTRA_TASK_INSTRUCTION = "com.ai.assistance.operit.voice.EXTRA_TASK_INSTRUCTION"
        const val EXTRA_TRIGGER_ID = "com.ai.assistance.operit.voice.EXTRA_TRIGGER_ID"
