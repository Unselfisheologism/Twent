...
class TriggersActivity : AppCompatActivity() {
    ...
    private fun checkNotificationPermission() {
        ...
        if (hasNotificationTriggers && !com.ai.assistance.operit.triggers.PermissionUtils.isNotificationListenerEnabled(this)) {
    ...
    private fun showDeleteConfirmationDialog(trigger: com.ai.assistance.operit.triggers.Trigger) {
        val dialog = AlertDialog.Builder(this)
